...
from torchvision.transforms import Resize, ToTensor, Normalize, Compose, CenterCrop, ColorJitter, ToPILImage
import PIL
...
class FaceNet(object):
    def __init__(self, size):
        ...
        self.face_detector = MTCNN(margin=150, post_process=False)
    ...
    def __call__(self, tensor):
        ...
        if face == None:
            ...
            #img save
            #save_image(face, './facenet_test.png')
        return face
        ...
        for phase, indices in split_profiles.items():
            if phase == 'train':
                for idx in indices:
                    ...
                    if p == 1 and profiles[idx].split("_")[-1] in ['18','19','20']:
