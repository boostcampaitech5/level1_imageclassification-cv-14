...
class MaskSplitByProfileDataset(MaskBaseDataset):
    ...
    def setup(self):
        ...
        profiles = [profile for profile in profiles if not profile.startswith(".") and profile.split("_")[-1] not in ["59"]]
        for profile in profiles:
            if profile.split("_")[-1] in ["57","58"] and profile.split("_")[-2] == "female":
